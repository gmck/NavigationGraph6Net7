...
namespace com.companyname.navigationgraph6net7.Fragments
{
    public class SettingsFragment : PreferenceFragmentCompat
    {
        ...
        private void SetDefaultNightMode12(UiNightMode uiNightMode)
        {
            ...
            if (OperatingSystem.IsAndroidVersionAtLeast(31))        // if (Build.VERSION.SdkInt >= BuildVersionCodes.S) //Must use OperatingSystem.IsAndroidVersionAtLeast(xx) otherwise a warning 
